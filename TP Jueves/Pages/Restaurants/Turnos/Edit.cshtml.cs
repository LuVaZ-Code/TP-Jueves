    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var turno = await _db.TurnosDisponibles
                .Include(t => t.Restaurante)
                .FirstOrDefaultAsync(t => t.Id == TurnoDisponible.Id);
            ...
            turno.Fecha = TurnoDisponible.Fecha;
            turno.Horario = TurnoDisponible.Horario;
            turno.CapacidadMaxima = TurnoDisponible.CapacidadMaxima;
            turno.IsActive = TurnoDisponible.IsActive;

            await _db.SaveChangesAsync();
            return RedirectToPage("Index", new { restauranteId = turno.RestauranteId });
        }
    }
}
